...
We’ll recommend the aggregator that fits you best using **success rates & pricing** from our dataset.
""")
...
try:
    ...
    st.error("⚠️ Could not load backend dataset. Using sample fallback data.")
    sample_json = [
        {
            "Aggregator": "PayU",
