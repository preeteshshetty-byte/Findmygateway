...
We’ll recommend the aggregator that fits you best.
""")
...
industry = st.sidebar.selectbox("Select your industry", industries)
gmv = st.sidebar.selectbox("Select your average monthly GMV", gmv_ranges)
